...
CORRIDORS: list[Corridor] = [
    ...
    Corridor(
        ...
        path=[
            ...
            Coordinate(lat=18.0, lon=67.5), Coordinate(lat=22.0, lon=69.6),
        ],
    ...
    Corridor(
        ...
        path=[
            ...
            Coordinate(lat=7.5, lon=93.0), Coordinate(lat=9.0, lon=88.0),
            Coordinate(lat=11.0, lon=84.0), Coordinate(lat=13.0, lon=81.0),
        ],
